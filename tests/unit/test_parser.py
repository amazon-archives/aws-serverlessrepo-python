...
class TestParser(TestCase):
        ...
        expected_dict = OrderedDict(
            [
                (
                    "B_Resource",
                    OrderedDict(
                        [("Key2", {"Name": "name2"}), ("Key1", {"Name": "name1"})]
                    ),
                ),
                (
                    "A_Resource",
    ...
    def test_get_app_metadata_missing_metadata(self):
        ...
        expected = (
            "missing AWS::ServerlessRepo::Application section in template Metadata"
        )
    ...
    def test_get_app_metadata_return_metadata(self):
        ...
        template_dict = {
            "Metadata": {"AWS::ServerlessRepo::Application": dict(app_metadata)}
        }
    ...
    def test_strip_app_metadata_when_metadata_contains_additional_keys(self):
        template_dict = {
            "Metadata": {"AWS::ServerlessRepo::Application": {}, "AnotherKey": {}},
            "Resources": {},
        }
